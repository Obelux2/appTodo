...
var TodoList = /*#__PURE__*/function () {
  ...
  todo_list_class_createClass(TodoList, [{
    ...
    key: "contarCompletados",
    value: function contarCompletados() {
      var suma = 0;
...
var ulFiltos = document.querySelector('.filters');
var anchorFiltro = document.querySelectorAll('.filtro');
var cantidad = document.querySelector('strong');
...
divTodoList.addEventListener('click', function (event) {
  ...
  var idElement = liElement.getAttribute('data-id');

  if (nombreElemento == 'input') {
    todoList.marcarCompletado(idElement);
    liElement.classList.toggle('completed');
    var suma = todoList.contarCompletados();
...
btnBorrarCompletados.addEventListener('click', function (event) {
...
ulFiltos.addEventListener('click', function (event) {
  ...
  anchorFiltro.forEach(function (elem) {
